...
(function () {
  var GEO_URL = "/api/v1/ollaspopularesgeo/";
  var LIST_URL = "/ollas/";
  var LIST_BY_CITY_URL = "/ollas_ciudad/";
  var TITLE = "Olla Popular";
  var ICON_URL = "/static/icons/marker-icon-2x-green.png";
  
  /**
   * ListOllasPopularesView is the main component of the list.html page.
   *
   * @param {Object} map leaflet map instance
   */
  function ListOllasPopularesView(map, options) {
    this.map = map;
  ...
  ListOllasPopularesView.prototype.setupViewListeners = setupViewListeners;
  ListOllasPopularesView.prototype.switchClusteringInit = switchClusteringInit;
  ListOllasPopularesView.prototype.geoFindMe = geoFindMe;
  ListOllasPopularesView.prototype.getQuery = getQuery;
  ListOllasPopularesView.prototype.requestGeoData = requestGeoData;
  ListOllasPopularesView.prototype.loadMarkersAndGroup = loadMarkersAndGroup;
  ListOllasPopularesView.prototype.loadMarkers = loadMarkers;
  ListOllasPopularesView.prototype.groupMarkerRequest = groupMarkerRequest;
  ListOllasPopularesView.prototype.setupCitiesDropdown = setupCitiesDropdown;

  // export
  window.ListOllasPopularesView = ListOllasPopularesView;

  // implementation

  /**
   * ListOllasPopularesView.setupViewListeners
   */
